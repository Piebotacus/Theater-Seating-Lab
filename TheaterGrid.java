 ...
 *
 *  A TheaterGrid object represents a simple bounded grid.  In addition
 ...
 */
public class TheaterGrid extends BoundedGrid
{
     ...
     */
    public TheaterGrid(int numRows, int numCols)
    {
